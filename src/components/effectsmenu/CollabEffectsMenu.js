...
function EffectsMenu() {
  ...
  // bg-violet-600 bg-green-700 bg-blue-500 bg-red-700 bg-cyan-900
  return (
    <div className="grid col-span-4 place-items-center p-5 scrollbar-thin scrollbar-thumb-blue-700 scrollbar-track-blue-300 overflow-y-scroll h-96">
      {/* ROW 1 */}
